...
import VpDate from "./date/date.vue";
import VpDateRange from "./date/date.range.vue";

import VpPagination from "./present/pagination.vue";
import VpUploadImage from "./form/upload.image.vue";
import VpSpace from "./layout/space.vue";
import VpLoading from "./layout/loading.vue";
import VpList from "./present/list.vue";
import VpScan from "./qr/scan.vue";
import VpCard from "./layout/card.vue";
...
Vue.component('VpDateRange', VpDateRange);
Vue.component(`VpPagination`, VpPagination);
Vue.component('VpUploadImage', VpUploadImage);
Vue.component('VpSpace', VpSpace);
Vue.component('VpLoading', VpLoading);
Vue.component('VpList', VpList);
Vue.component('VpScan', VpScan);
Vue.component('VpCard', VpCard);